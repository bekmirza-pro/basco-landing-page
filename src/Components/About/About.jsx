    ...
    <div className='about__box'>
      <section className='about'>
        ...
        <div className='about__parag'>
          ...
          xodimlarni birlashtiradigan yagona texnologiya mavjud bo’lmasa,
          bugungi raqobatdosh bozorga dosh berish va rivojlanish mumkin bo’lmay
          qoladi. <br /> <br /> Agar sizning biznesingiz ham bir nechta
          bo’lim-larga va katta jamoaga ega bo’lsa… <br /> <br /> Sizga barcha
          biznes jarayonlarini avtomatlash-tiradigan, xodimlaringiz
        ...
        {shower ? (
          <Fade top>
            <div className='about__parag'>
              ...
              talablarini bajara olmaysiz.
              <br /> <br /> Natijada, ular sizni emas, raqobatchilaringizni
              tanlab ketishadi. Bozordagi ulushingiz keskin kamayib, biznesingiz
              qutqarib bo’lmas jar yoqasiga kelib qoladi. <br />
              <br /> Lekin, biz hozir bu xabarlar bilan sizning kayfiyatingizni
              tushirmoqchi emasmiz. Biz sizning shunday muammolaringizga yechim
              bermoqchimiz. <br /> <br /> Agar biznesingizning bugungi va
              ertangi holatiga befarq bo’lmasangiz… Har bir so’zimizni diqqat
              bilan o’qishni maslahat beramiz. Ishonamizki, sarflagan vaqtingiz
              siz uchun eng manfaatlisi bo’ladi.
            </div>
          </Fade>
        ) : (
          ""
