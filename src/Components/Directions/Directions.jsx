...
const bolim2Parag = (
  <p>
    ...
    оптимал ёндашув. <br />
    <br /> БAСCО ЕРП платформасининг CРМ бўлими сотув менежерларингизга жуда ҳам
    ёққан бўларди. <br />
...
const bolim4Parag = (
  <p>
    ...
    <br /> БAСCО ЕРП платформаси ҲР бўлимининг баъзи енг муҳим имкониятлари:{" "}
    <br />
    <br />
...
const bolim5Parag = (
  <p>
    ...
    <br /> БAСCО ЕРП платформасининг Маош бўлими орқали еса сиз шу ва шу каби
...
const bolim7Parag = (
  <p>
    ...
    <br /> БAСCО ЕРП платформасининг Назорат бўлими компания раҳбари ҳамда маош
...
const bolim8Parag = (
  <p>
    ...
    фойдали бўлади. <br />
    <br /> BASCO ЕРП платформасининг енг муҳим имкониятлари қуйидагилар: <br />
    <br />
...
const bolim10Parag = (
  <p>
    ...
    <br />
    <br />
    БAСCО ЕРП платформасининг ушбу бўлими компаниянгизнинг турли шахслар билан
...
const bolim12Parag = (
  <p>
    {" "}
    Ishlab chiqarish bo’limi orqali kompaniya ishlab chiqarishda bo’layotgan
    ortiqcha xarajatlarni ko’ra oladi hamda real ishlab chiqarishni to’g’ri
    nazorat qila oladi. <br />
    <br /> Boʻlimning umumiy imkoniyatlari: <br />
    <br /> ●Mahsulot ishlab chiqarish. <br /> ●Mahsulot ishlab chiqarishda har
    bir mahsulotga ketadigan xom-ashyolarni toʻliq kiritish imkoniyati orqali
    har bir mahsulotning tannarxini ham hisoblash imkoniyati. <br /> ●Mahsulot
    ishlab chiqarishda xom-ashyo bilan birga polufabrikatlarni ham tayyor
    mahsulot ishlab chiqarish ichiga kiritish imkoniyati. <br /> ●Ishlab
    chiqarilayotgan mahsulotning soniga karab tannarxi va summasini ham koʻrish
    mumkin.
    <br /> ●Mahsulot ishlab chiqarishda xom-ashyo yoki polufabrikat agar skladda
    bulmasa, ishlab chiqarishga ruxsat bermaydi. Bu real holatni analiz qilib
    turishni osonlashtiradi. <br /> ●Ishlab chiqariladigan mahsulotlar
    roʻyxatini kiritganda unga kerakli boʻlgan xom-ashyolarni skladdan avtomatik
    toʻldirib quyish imkoniyati mavjud. <br /> ●Yaroqsiz mahsulotlar skladga
    kaytganda mahsulotlarni qayta ishlash funksiyasi ham mavjud. <br /> ●Qayta
    ishlash funksiyasi orqali bir turdagi mahsulotdan ikkinchi turdagi
    mahsulotni ham qayta ishlash mumkin. <br /> ●Ishlab chiqarish uchun kerak
    boʻlgan xom-ashyolarni xom-ashyo skladidan ajratib saqlash uchun va tayyor
    boʻlgan mahsulotlarni saqlash uchun alohida ishlab chiqarish skladi. <br />{" "}
    ●Skladdan skladga xom-ashyo va tayyor mahsulot oʻtkazish funksiyasi. <br />{" "}
    ●Ishlab chiqarish skladini nazorat qilish uchun sklad hisoboti. <br />{" "}
    ●Ishlab chiqarish uchun norma belgilash orqali xohlagan davrni tanlab,
    ishlab chiqarish kam yoki koʻp boʻlayotgani haqida maʼlumot olish. <br />{" "}
    ●Ishlab chiqarishga mahsulot buyurtma berish. <br /> ●Ishlab chiqarish uchun
    kerakli xom-ashyolarga buyurtma berish. <br /> ●Kamaygan va koʻpaygan
    mahsulotlar haqida hisobot olish orqali mahsulotlar miqdorini toʻgʻri
    nazorat qila olish imkoniyati. <br /> ●Ishlab chiqarishga sarflangan
    xom-ashyoning kam yoki koʻp sarf boʻlayotgani haqida hisobot olish. <br />{" "}
